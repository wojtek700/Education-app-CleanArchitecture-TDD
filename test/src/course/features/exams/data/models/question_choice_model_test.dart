...
void main() {
  ...
  group('QuestionChoiceModel', () {
    ...
    group('fromMap', () {
      test('should return a valid [QuestionChoiceModel] when the JSON '
          'is not null', () async {
    ...
    group('fromUploadMap', () {
      test('should return a valid [QuestionChoiceModel] when the JSON '
          'is not null', () async {
        final map =
            jsonDecode(fixture('uploaded_exam_question_choice.json'))
                as DataMap;
    ...
    group('copyWith', () {
      test(
        'should return a new [QuestionChoiceModel] with the same values',
        () async {
